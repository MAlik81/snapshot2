					...
					<div class="box box-success hvr-grow-shadow">
						...
						<div class="box-body text-center">
							...
							@if($package->aws_storage == 0)
								Unlimited Storage
							@else
								{{$package->aws_storage}}GB Storage
							@endif
							<br/>
							...
							<h3 class="text-center">
								@if($package->price != 0)
									...
									<small>
										/ {{$package->interval_count}} {{$package->interval}}
									</small>
								@else
									@lang('superadmin::lang.free_for_duration', ['duration' => $package->interval_count . ' ' .$package->interval])
								@endif
							</h3>
