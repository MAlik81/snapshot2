<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-xs-12">
            <div class="form-group">
            	{!! Form::label('STRIPE_TRANSACTION_CHARGES', 'Stripe Transaction Charges (%) :') !!}
            	{!! Form::text('STRIPE_TRANSACTION_CHARGES', $default_values['STRIPE_TRANSACTION_CHARGES'], ['class' => 'form-control','placeholder' => 'Stripe Transaction Charges %']); !!}
            </div>
        </div>
