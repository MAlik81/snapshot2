            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Confirm Subscription Cancellation</h5>
...
@section('javascript')
    ...
    <script type="text/javascript">
		...
		var url = '';
            // Open the modal when the user clicks on a button or link to cancel their subscription
            function cancelSub(link) {
				url = link;
        ...
        $(document).ready(function() {
            ...
            // Perform the cancellation when the user confirms
            $('#confirmCancel').on('click', function() {
                // Get the URL from the button's data-href attribute
                // var url =  $('#cancelSubscriptionButton').data('link');

                // Make an AJAX request to the URL
                $.ajax({
                    url: url,
                    type: 'GET', // Or whatever HTTP method your server expects
                    success: function(result) {
