...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->group(function () {
    ...
    Route::get('/all-subscriptions/{subcription_id}/cancel', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'destroy']);
    ...
    Route::get('/cancel-sub/{subcription_id}', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'cancelSub'])->name('cancel-sub');
