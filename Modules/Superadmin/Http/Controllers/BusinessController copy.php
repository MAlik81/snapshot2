...
class BusinessController extends BaseController
{
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $eventphotoModel = EventAlbumPhotos::where('business_id', $business_id)
            ...
            Eventalbums::where('business_id', $business_id)->delete();
            // delete event where business_id = $business_id
            Event::where('business_id', $business_id)->delete();
            // delete event photo discount where business_id = $business_id
            EventPhotoDiscount::where('business_id', $business_id)->delete();
            // delete shopping cart where business_id = $business_id
            ShoppingCart::where('business_id', $business_id)->delete();
            // delete overlay image where business_id = $business_id
            OverlayImage::where('business_id', $business_id)->delete();
