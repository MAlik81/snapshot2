...
class SuperadminSettingsController extends Controller
{
    ...
    public function edit()
    {
        ...
        $default_values = [
            ...
            'STRIPE_TRANSACTION_CHARGES' => $is_demo ? null : env('STRIPE_TRANSACTION_CHARGES'),
            ...
            'facebook_link' => $is_demo ? null : env('facebook_link', 'https://www.facebook.com/'),
            'twitter_link' => $is_demo ? null : env('twitter_link', 'https://twitter.com/'),
            'instagram_link' => $is_demo ? null : env('instagram_link'),
            'youtube_link' => $is_demo ? null : env('youtube_link', 'https://www.youtube.com/'),
        ];
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $env_settings = $request->only(['APP_NAME', 'APP_TITLE',
                ...
                'STRIPE_SECRET_KEY', 'STRIPE_TRANSACTION_CHARGES','PAYPAL_MODE',
