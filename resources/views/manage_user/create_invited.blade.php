...
@section('content')
    ...
    <section class="content">
        <p class="form-header text-white">Signup</p>
        {!! Form::open([
        ...
        <div class="row">
            <input type="hidden" name="business_id" value="{{$invitation->business_id}}">
            <input type="hidden" name="event_id" value="{{$invitation->event_id}}">
            <input type="hidden" name="invitation_id" value="{{$invitation->id}}">
            <div class="col-md-12">
                {{-- @component('components.widget', ['title' => 'Personal Data']) --}}
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('email', $is_invitation ? $invitation->email : null, [
                                'class' => 'form-control',
                                'required',
        ...
        <div class="form-group">
          {!! Form::label('service_staff_pin', __( 'lang_v1.staff_pin' ) . ':') !!}
            ...
            <div class="col-md-12">
                {{-- @component('components.widget', ['title' => 'Login Details']) --}}
                    @if ($is_invitation)
