<div class="modal fade" id="responceModal" tabindex="-1" role="dialog" aria-labelledby="responceModalLabel" aria-hidden="true">
        ...
        <div class="modal-content" style="border-radius: 20px; background:none;border:none;">
            ...
            <div class="modal-body">
                ...
                <div class="p-5 bg-white" style="border-radius:20px; width:100%">
                    ...
                    <h1 class="text-center" style="font-size: 32px;color: #000;line-height: 40px;font-weight:900;"><b><strong><span id="account_responce_modal" ></span></strong></b></h1>
