            ...
            @component('components.widget', ['class' => 'box-primary', 'title' => 'Upload Images'])
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        {!! Form::label('meta_data', 'Photos tags(Meta Data):') !!}
                        {!! Form::textarea('meta_data', null, ['class' => 'form-control', 'rows' => 3,'placeholder'=>'You can add comma-separated tags that will be associated with all images for SEO and optimization purposes.']) !!}
                    </div>
                </div>
                <div class="col-sm-12">
...
@section('javascript')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Immediately remove unsupported files after being added to the dropzone
            myDropzone.on("addedfile", function(file) {
                ...
                if (!isValidFile) {
                    ...
                    myDropzone.removeFile(file); // Remove unsupported file immediately
                    return; // Stop further execution for this file
                }

                // Proceed with adding the file preview and other logic if the file is supported
