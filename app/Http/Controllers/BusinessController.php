    ...
    */
        ...
        try {
            $validator = $request->validate(
                ...
                [
                    ...
                    'camera_details.required' => 'Please provide camera details',
                ]
            );
            ...
            //Create owner.
            $owner_details = $request->only(['surname', 'first_name', 'last_name', 'username', 'email', 'password', 'language','camera_details']);
            ...
            $business_details['currency_id'] = 6;
            $business_location = $request->only(['name']);
            ...
            $business_details['camera_details'] = $owner_details['camera_details'];
    ...
    public function postBusinessSettings(Request $request)
    {
        ...
        try {
            ...
            $business_details['custom_labels'] = json_encode(array());
